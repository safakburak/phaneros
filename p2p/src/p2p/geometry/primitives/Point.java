package p2p.geometry.primitives;
...
public class Point {
	...
	/**
	 * Calculates the cross product of two vectors (p0, p1) and (p1, p2) defined
	 * by three points p0, p1 and p2.
	 * 
	 * @param p0
	 *            The first point
	 * @param p1
	...
	/**
	 * Determines whether two vectors (p0, p1) and (p1, p2) defined by three
	 * points p0, p1 and p2 make a left turn.
	 * 
	 * @param p0
	 *            The first point
	 * @param p1
	...
	/**
	 * Determines whether two vectors (p0, p1) and (p1, p2) defined by three
	 * points p0, p1 and p2 make a right turn.
	 * 
	 * @param p0
	 *            The first point
	 * @param p1
