...
public class MainFrame extends javax.swing.JFrame {
    ...
    public MainFrame() {
        ...
        voronoiDiagram = new ArrayList<Polygon>();
        state = 0;
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Fortune's algorithm - O(n∙log(n))");
        ...
        jButton2.setText("via Halfplanes intersection - O(n³)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        voronoiDiagram = VoronoiDiagram.viaHalfplanesIntersection(points);
    ...
    private ArrayList<Polygon> voronoiDiagram;
    private int state;
}
